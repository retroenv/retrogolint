...
func TestAnalyzer_AnalyzeFiles_SkipsGeneratedFile(t *testing.T) {
	dir := t.TempDir()
	path := filepath.Join(dir, "generated.go")
	source := `// Code generated by github.com/oapi-codegen/oapi-codegen/v2 version v2.8.0 DO NOT EDIT.
